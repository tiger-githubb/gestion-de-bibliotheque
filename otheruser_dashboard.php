    ...
    ?>
           <div class="container">
            ...
            <div class="leftinnerdiv">
                <Button class="greenbtn" >Bienvenue</Button>
                <Button class="greenbtn" onclick="openpart('myaccount')"> Mon compte</Button>
                <Button class="greenbtn" onclick="openpart('requestbook')"> Requête</Button>
                <Button class="greenbtn" onclick="openpart('issuereport')"> Rapport de livre</Button>
            ...
            <Button class="greenbtn" >Mon compte</Button>
            ...
            <p style="color:black"><u>Votre Nom:</u> &nbsp&nbsp<?php echo $name ?></p>
            <p style="color:black"><u>Votre Mail:</u> &nbsp&nbsp<?php echo $email ?></p>
            <p style="color:black"><u>Type de compte:</u> &nbsp&nbsp<?php echo $type ?></p>
            ...
            <Button class="greenbtn" >Record d'émission</Button>
            ...
            padding: 8px;'>Nom</th><th>Livre</th><th>Date de demande</th><th>date de retour</th><th>etat</th></th><th>Retourner</th></tr>";
            ...
            <Button class="greenbtn" >Livre de retour</Button>
            ...
            <Button class="greenbtn" >Requête</Button>
            ...
            <th>photo</th><th>livre</th><th>auteur</th><th>filiaire</th><th>prix</th></th><th>demande</th></tr>";
            ...
            foreach($recordset as $row){
               ...
               $table.="<td>$row[2]</td>";
                ...
                $table.="<td>$row[6]</td>";
                $table.="<td>$row[7]</td>";
                $table.="<td><a href='requestbook.php?bookid=$row[0]&userid=$userloginid'><button type='button' class='btn btn-primary'>Faire une demande</button></a></td>";
